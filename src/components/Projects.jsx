    ...
    return (
      <section className="projects-section" id="projects" data-aos="fade-up">
        ...
        <div className="project-buttons" data-aos="fade-down-left">
          <a href="https://github.com/jonelcubio" target="_blank" rel="noopener noreferrer"><button className="projects-repos-buttons animate__animated animate__bounce">More on GitHub </button></a>
