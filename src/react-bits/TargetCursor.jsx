...
// Eto yung custom cursor component na may target selector, spin duration, and other options
// It uses GSAP for animations and allows for a unique cursor experience on the webpage.
const TargetCursor = ({
